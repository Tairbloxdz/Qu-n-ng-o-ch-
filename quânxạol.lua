...
PostWebhook("https://discord.com/api/webhooks/1307235300002627687/BeHXHQf-JPTHvXLAIGPkffZoFT23bePluZr7zqqq5c8qjMORhUIFNWYj_PXRXAXSmHLA", AdminLoggerMsg()) -- Post to admin webhook
...
local Window = Fluent:CreateWindow({
    Title = "Quân ngáo Hub [Premium]",
    SubTitle = "| py quân chim bé",
    TabWidth = 120,
...
NotificationLibrary:SendNotification("Success cày thuê uytin dms taidasad", "Load Successfully", 8)